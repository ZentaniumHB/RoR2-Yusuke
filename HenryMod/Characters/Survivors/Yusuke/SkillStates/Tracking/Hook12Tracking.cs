...
{
    public class Hook12Tracking : HuntressTracker
    {
        public static Color Yellow = new Color(0.941f, 0.882f, 0.353f, 1f);
        ...
        private void Awake()
        {
            ...
            if (gameObject != null)
            {
                ...
                {
                    componentsInChildren[i].color = Yellow;
                }
